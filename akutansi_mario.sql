...
--
-- Table structure for table `karyawan_mario`
--

CREATE TABLE `karyawan_mario` (
  `nik_mario` varchar(16) NOT NULL,
  `nama_karyawan_mario` varchar(25) NOT NULL,
  `alamat_mario` varchar(50) NOT NULL,
  `telpon_mario` varchar(13) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `karyawan_mario`
--

INSERT INTO `karyawan_mario` (`nik_mario`, `nama_karyawan_mario`, `alamat_mario`, `telpon_mario`) VALUES
('123445', 'mario pandi', 'pekanbaru', '08222388484'),
('78545678', 'jokowi widodo', 'samosirrr', '0811111111111');
